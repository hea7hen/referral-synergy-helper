      ...
      <div className="container px-4 py-12 md:py-16 md:px-6">
        ...
        <div className="mt-12 border-t pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-xs text-muted-foreground">
            © {new Date().getFullYear()} ReferralSync. All rights reserved.
          </p>
          <div className="mt-4 md:mt-0 flex items-center gap-4">
            <Link to="#" className="text-muted-foreground hover:text-foreground">
              <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" className="h-5 w-5" viewBox="0 0 16 16">
